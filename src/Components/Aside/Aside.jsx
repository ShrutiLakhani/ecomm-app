          ...
          <ul className="categories-list">
            <li>
              <input
                type="checkbox"
                id="ct1"
                className="input-prod-category"
                name="cateogry"
                checked={filterState.category.includes("Tote")}
                value="Tote"
                onChange={(e) =>
            ...
            <li>
              <input
                ...
                className="input-prod-category"
                name="category"
                checked={filterState.category.includes("Wallet")}
                value="Wallet"
                onChange={(e) =>
                  filterDispatch({ type: "CATEGORY", payload: e.target.value })
                }
            ...
            <li>
              <input
                type="checkbox"
                className="input-prod-category"
                checked={filterState.category.includes("Watch")}
                value="Watch"
                onChange={(e) =>
                  filterDispatch({ type: "CATEGORY", payload: e.target.value })
                }
            ...
            <li>
              <input
                type="checkbox"
                className="input-prod-category"
                checked={filterState.category.includes("Footwear")}
                value="Footwear"
                onChange={(e) =>
                  filterDispatch({ type: "CATEGORY", payload: e.target.value })
                }
          ...
          <ul className="categories-list">
            <li>
              <input
                ...
                id="brand-chkbox"
                value="Michael Kors"
                checked={filterState.brand.includes("Michael Kors")}
                onChange={(e) =>
                  filterDispatch({ type: "BRAND", payload: e.target.value })
                }
              ></input>
              <label
                htmlFor="brand-chkbox"
                className="checkbox left-sidebar-checkbox left-sidebar-label"
              >
                Michael Kors
              </label>
            </li>
            <li>
              <input
                ...
                className="input-prod-category"
                value="Coach"
                checked={filterState.brand.includes("Coach")}
                onChange={(e) =>
                  filterDispatch({ type: "BRAND", payload: e.target.value })
                }
              ></input>
            ...
            <li>
              <input
                ...
                className="input-prod-category"
                value="Jimmy Choo"
                checked={filterState.brand.includes("Jimmy Choo")}
                onChange={(e) =>
                  filterDispatch({ type: "BRAND", payload: e.target.value })
                }
              ></input>
            ...
            <li>
              <input
                ...
                className="input-prod-category"
                value="Gucci"
                checked={filterState.brand.includes("Gucci")}
                onChange={(e) =>
                  filterDispatch({ type: "BRAND", payload: e.target.value })
                }
              ></input>
        ...
        <div className="left-sidebar-filter-section category-container">
          ...
          <div className="checkbox">
            <div>
              ...
              ></input>
              <label className="radio left-sidebar-label">4 Stars Above</label>
            </div>
            <div>
              <input
                type="radio"
              ...
              ></input>
              <label className="radio left-sidebar-label">3 Stars Above</label>
            </div>
            <div>
              <input
                type="radio"
              ...
              ></input>
              <label className="radio left-sidebar-label">2 Stars Above</label>
            </div>
            <div>
              <input
                type="radio"
              ...
              ></input>
              <label className="radio left-sidebar-label">1 Stars Above</label>
            </div>
          </div>
        </div>
        <div className="left-sidebar-filter-section category-container">
          ...
          <div className="checkbox">
            <div>
              ...
              ></input>
              <label className="radio left-sidebar-label">High to Low</label>
            </div>
            <div>
              <input
                type="radio"
              ...
              ></input>
              <label className="radio left-sidebar-label">Low to High</label>
            </div>
          </div>
        </div>
      </aside>
